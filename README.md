...
* Download the `aind-universal.yml` file at the [repo](https://github.com/mohandesosama/Solving-Sudoku-Puzzle-with-AI/blob/master/aind-universal-v3.yml) (right click, save file). __NOTE__: Some browsers will automatically append a ".txt" extension to the yml file; if your browser does this, then you will need to remove the extension or alter the creation command to correct it.
